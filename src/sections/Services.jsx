/* ========================================
   ...
   3x2 grid with icons, hover glow
...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    <div className="service-card glass rounded-2xl p-6 md:p-8 card-hover group relative overflow-hidden">
    ...
    <section id="services" ref={sectionRef} className="section-padding relative">
      ...
      <div className="section-container relative z-10">
        <SectionHeading
          ...
          subtitle="From concept to deployment — I build solutions that scale."
        />
